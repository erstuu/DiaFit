...
import com.health.diafit.databinding.FragmentTipsFoodMenuBinding
import com.health.diafit.databinding.FragmentTipsFoodPageBinding
import com.pierfrancescosoffritti.androidyoutubeplayer.core.player.YouTubePlayer
import com.pierfrancescosoffritti.androidyoutubeplayer.core.player.listeners.AbstractYouTubePlayerListener

class TipsFoodMenuFragment : Fragment() {
    private var _binding: FragmentTipsFoodMenuBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTipsFoodMenuBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupYoutubeView() {
        ...
        ytView.addYouTubePlayerListener(object : AbstractYouTubePlayerListener() {
            override fun onReady(youTubePlayer: YouTubePlayer) {
                val videoId = getString(R.string.tips_makanan_sehari_id)
